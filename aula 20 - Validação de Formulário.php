...
$erroRepeteSenha ="";
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST'){
       ...
       if(($erroNome=="") && ($erroEmail=="") && ($erroSenha=="") && ($erroRepeteSenha=="")){
           header('Location: aula 20 - obrigado.php');
       } 

    }
   // trim tirar espaço, stripslacher tirar as barras, htmlespecialchars pra tirar caracteres especias. pra limpas o post que virá. 
